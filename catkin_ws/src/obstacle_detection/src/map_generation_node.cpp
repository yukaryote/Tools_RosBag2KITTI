...
{
    sub_lidar = nh.subscribe("/ts_point_cloud", 1000, &MapGenerationNode::lidarCallback, this);
...
void MapGenerationNode::lidarCallback(const sensor_msgs::PointCloud2::ConstPtr& lidar)
{
	...
	char s[200];
	sprintf(s, "/home/iyu/Tools_RosBag2KITTI/catkin_ws/output/pcd/%06lld.pcd", lidar_index); 
	++lidar_index;
	camera_captured = false;
    pcl::PointCloud<pcl::PointXYZRGB> rgb_cloud;
    pcl::fromROSMsg(*lidar, rgb_cloud);
    pcl::copyPointCloud(rgb_cloud, lidar_cloud);
